...
while (player1.Character.health > 0 && player2.Character.health > 0)
{
    ...
    player2.Character.health -= player1.Character.attack();
    Console.WriteLine(player1.Name + " HP:" + player1.Character.health + " " + player2.Name + " HP:" + player2.Character.health + "\n");
    ...
    player1.Character.health -= player2.Character.attack();
